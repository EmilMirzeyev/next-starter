...
const PrivacyPolicy = () => {
  return (
    <div className='container'>
      <div className='my-8'>
        <h1 className='text-brand-600 text-30px700 p-3 pl-5 rounded-2xl bg-brand-25 h-[62px] border border-brand-25'>Məxfilik siyasəti</h1>
      </div>
      <div className="border border-gray-200 rounded-3xl p-8 flex flex-col gap-y-6">
        ...
        <div className="flex flex-col gap-y-2">
          ...
          <p className="text-gray-500 text-16px500">
            ...
            Azərbaycan Respublikası Prezidentinin 2013-cü il 5 mart tarixli 833
            nömrəli Fərmanı ilə təsdiq edilmiş “Azərbaycan Respublikasının
            Rəqəmsal İnkişaf və Nəqliyyat Nazirliyi yanında Elektron
            Təhlükəsizlik Xidməti haqqında Əsasnamə”(bundan sonra – Əsasnamə) və
            digər qanunvericilik aktları ilə müəyyən edilən səlahiyyət və
        ...
        <div className="flex flex-col gap-y-2">
          ...
          <p className="text-gray-500 text-16px500">
            ...
            və təkliflərin qəbulu prosesində: müraciət edən şəxsin adı, soyadı,
            ata adı, telefon nömrəsi, e-poçt ünvanı və müraciətə əlavə edilən
            hər hansı sənəddə göstərilən fərdi məlumatlar (əgər,
            ...
            şikayətdə göstərilən halların araşdırılması məqsədilə zəruri olduğu
            və qanunvericilikdə tələb olunduğu hallardan başqa, fərdi məlumatlar
            üçüncü şəxslərlə paylaşılmır və onların məxfiliyi qorunur.
          </p>
        </div>
      </div>
    </div>
