...
const CreateAnnouncement = () => {
    return (
        <div className="container mt-8 flex gap-x-6 relative">
            ...
            <div className='border border-gray-200 rounded-2xl p-6 min-w-[360px] h-full flex flex-col gap-y-5 sticky top-0'>
                ...
                <Link href='/dashboard/privacy-policy' className="text-brand-500 text-14px400 underline underline-offset-[3px]">
                    Bütün qaydaları oxu
                </Link>
            </div>
        </div>
