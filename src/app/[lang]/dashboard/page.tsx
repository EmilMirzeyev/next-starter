            ...
            <div className="bg-gray-100 py-3">
                <nav className="flex items-center justify-between container text-14px500">
                    <ul className="flex items-center gap-x-8">
                        <li><Link href={""}>Digər elanlar</Link></li>
                        <li><Link href={""}>Şəxsi kabinet</Link></li>
                        <li><Link href={""}>Balans</Link></li>
                        <li><Link href={""}>Abunəliklər</Link></li>
                        <li><Link href={""}>Tənzimləmələr</Link></li>
                    </ul>
                    <ul className="flex items-center gap-x-8">
