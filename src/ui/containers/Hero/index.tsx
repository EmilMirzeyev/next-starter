...
const Hero = () => {
    ...
    return (
        ...
        >
            ...
            <div className="container text-white py-[300px] flex mobile:pb-0 mobile:-mb-4 mobile:pt-36">
                <div className="w-full lg:w-1/2">
                    <div className="flex flex-col gap-8 lg:gap-12">
                        <div className="flex flex-col gap-4">
                            ...
                            <p className="text-16px400 text-gray-800 mobile:text-14px400 mobile:pr-6">
                                Amet minim mollit non deserunt ullamco est sit aliqua dolor do
                                amet sint. Velit officia consequat duis enim velit mollit.
                                Exercitation veniam consequat sunt nostrud amet.
                            </p>
                        </div>
                        <div className="flex gap-x-4 mobile:justify-center">
                            ...
                            <Link href="#about">
                                ...
                                >
                                    Haqqımızda
                                    <div>
                                        <ArrowRightSVG stroke="#fff" className="rotate-90 mobile:size-5" />
                                    </div>
                                </Button>
                            </Link>
                        </div>
