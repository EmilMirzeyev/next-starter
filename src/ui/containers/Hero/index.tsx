...
const Hero = () => {
    return (
        ...
        >
            ...
            <div className="container text-white py-[300px] flex">
                <div className="w-full lg:w-1/2">
                    <div className="flex flex-col gap-8 lg:gap-12">
                        <div className="flex flex-col gap-4 ">
                            ...
                            >
                                <h2 className="lg:text-14px600 text-12px400">
                                    “Car Buy” B2B avtomobil alış-satış sistemi
                                </h2>
                            </div>
                            <h1 className="lg:text-72px700 text-36px700 text-brand-700">
                                Sürətli və rahat interfeys
                            </h1>
                            <p className="text-16px400 text-gray-800">
                        ...
                        <div className="relative flex gap-4">
                            <HeroSVG className="absolute -left-8 -top-8 text-brand-500" />
                            <Button
                                aria-label="Log in"
                            ...
                            <Link href="#about">
                                <Button
                                    ...
                                    className="text-18px600 rounded-[28px] bg-gray-100 flex items-center gap-2.5"
                                >
                                    Haqqımızda
                ...
                <div className="flex relative -right-[56px]">
                    <Awsome1SVG className="absolute z-10 left-7 text-black" aria-hidden="true" />
                    <Awsome2SVG
