...
const ChangeLanguage = () => {
  ...
  return (
    ...
    >
      <div
        className={cn(
          "relative max-h-12 flex items-center bg-transparent hover:bg-[rgba(255,255,255,0.1)] hover:border-gray-400 border-2 border-gray-500 text-16px600 py-3 pl-[18px] pr-3 rounded-3xl text-white duration-300"
        )}
      >
        ...
        <div
          className={cn(
            "absolute top-14 -left-1 bg-brand-950 overflow-hidden p-4 rounded-xl duration-500 ease-in-out",
