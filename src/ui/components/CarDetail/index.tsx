...
const CarDetail = () => {
    ...
    const phoneNumber = "+994 01 234 56 78";
                ...
                <div className="min-w-[360px] flex flex-col gap-y-5  sticky top-0 h-full">
                    <div className="p-5 rounded-[20px] border border-gray-200 flex flex-col gap-y-5">
                        ...
                        <div className="text-brand-600 text-16px600  py-2.5 px-3.5 bg-brand-50 rounded-xl flex justify-center gap-x-1 items-center">
                            Sifarişlə
                            <ShoppingBagSVG className="text-brand-500" />
                        </div>
                    </div>
                    <div className="p-5 rounded-[20px] border border-gray-200 flex flex-col gap-y-5">
                        <button
                            className="bg-success-500 text-white rounded-[28px] h-14 flex flex-col justify-center items-center"
                            onClick={toggleNumberVisibility}
                        >
                            <h3
                                className={cn(
                                    "text-12px500",
                                    isNumberVisible ? "opacity-0" : "opacity-100"
                                )}
                            >
                                Nömrəni göstər
                            </h3>
                            <div
                                className={cn(
                                    "flex items-center gap-x-2 transition-all duration-300 ease-in-out",
                                    isNumberVisible ? "-translate-y-2" : "translate-y-0"
                                )}
                            >
                                <PhoneCallSVG />
                                <p className="text-base font-bold ">
                                    {isNumberVisible ? phoneNumber : getMaskedNumber(phoneNumber)}
                                </p>
                            </div>
                        </button>
                        <Link
                    ...
                    <div className="flex flex-col gap-y-5">
                        <Button
                            ...
                            className="h-11 gap-x-1.5 bg-gray-100 text-16px600 rounded-[22px]"
                        >
                            Lizinq üçün sorğu
                        ...
                        <Button
                            ...
                            className="h-11 gap-x-1.5  bg-gray-950 text-16px600 rounded-[22px] brigh"
                        >
                            Barter təklif et
                        ...
                        <div className="flex gap-x-3 justify-between items-center">
                            <div className="flex gap-x-3">
                                ...
                                <div className="flex flex-col gap-y-2">
                                    <h3 className="text-16px500">Cybrary Cars</h3>
                                    <div className="flex gap-x-3">
