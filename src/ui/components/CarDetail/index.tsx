            ...
            <div className="flex flex-col gap-y-5">
                ...
                <article className="border border-gray-200 rounded-2xl p-8 flex flex-col gap-y-6">
                    ...
                    <div className="flex justify-between gap-x-8">
                        ...
                        <ul className="w-1/2 flex flex-col gap-y-2">
                            ...
                            <li className="flex items-center justify-between">
                                <h3 className="text-gray-500 text-14px400">Sürətlər qutusu</h3>
                ...
                <article className="border border-gray-200 rounded-2xl p-8 flex flex-col gap-y-6">
                    ...
                    <div>
                        ...
                        >
                            2020 model Ford Fusion Titanium ideal vəziyyətdədir! 2.0L EcoBoost
                            mühərriki, 245 at gücü, tam ötürücülü (AWD) transmissiya ilə
                            təchiz olunmuşdur. Full paket: dəri salon, adaptiv kruiz-kontrol,
                            Apple CarPlay/Android Auto dəstəyi, 12 dinamikli premium səs
                            sistemi və panorama lyuk mövcuddur. Yürüş: 45,000 km. Avtomobilin
                            həm estetik, həm də texniki baxımdan heç bir problemi yoxdur. Nağd
                            və ya ilkin ödənişsiz kreditlə əldə etmək mümkündür. 1 il zəmanət
                            və bank yolu ilə sərfəli şərtlər təklif olunur. Ətraflı məlumat və
                            test sürüşü üçün əlaqə saxlayın!
                        </p>
                        <button
                ...
                <article className="border border-gray-200 rounded-2xl p-8 flex flex-col gap-y-6">
                    <h2 className="text-gray-800 text-24px600">Avtomobilin təchizatı</h2>
                ...
                <div className="p-5 rounded-[20px] border border-gray-200 flex gap-x-3 justify-between items-center">
                    <div className='flex gap-x-3'>
                        ...
                        <div>
                            ...
                            <p className="text-brand-500 text-14px400 underline underline-offset-[3px]">42 elan</p>
                        </div>
                    </div>
                    <div className="bg-brand-500 rounded-md px-2 py-1 text-white text-12px600">Avtosalon</div>
                </div>
                <div className="flex gap-x-3">
